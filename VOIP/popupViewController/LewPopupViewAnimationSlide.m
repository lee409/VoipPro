...
- (void)showView:(UIView *)popupView overlayView:(UIView *)overlayView{
    ...
    switch (_type) {
        ...
        case LewPopupViewAnimationSlideTypeBottomBottomNoneDiss:
        case LewPopupViewAnimationSlideTypeBottomBottomEdge:
    ...
    CGRect popupEndRect;
    if (_type == LewPopupViewAnimationSlideTypeBottomBottomEdge) {
...
- (void)dismissView:(UIView *)popupView overlayView:(UIView *)overlayView completion:(void (^)(void))completion{
    ...
    if (_type == LewPopupViewAnimationSlideTypeBottomBottomNoneDiss) {
        return;
    }
